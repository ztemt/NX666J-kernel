...
struct aw_bin {
	/* Offset pointer (backward offset pointer to obtain frame header information and important information) */
	char *p_addr;
	...
	/* Frame header information and other important data obtained after parsing */
